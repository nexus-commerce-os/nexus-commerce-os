...
| --- | --- | --- | --- | --- | --- |
| **R-01** | **Provider approval delayed or refused.** Affiliate networks approve accounts, then approve merchants individually | Medium | **Blocks P0.3 entirely** | Apply to Impact first, CJ second (the ratified sequence). No connector is written meanwhile. **The project waits — it does not simulate a provider** | Founder |

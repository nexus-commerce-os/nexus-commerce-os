...
import { Button, Card, Eyebrow, Modal, Select, ToastProvider, useToast } from '@nexus/ui';
    ...
    <>
      ...
      <Modal open={open} onClose={() => setOpen(false)} title="Confirm hand-off">
        <p className="muted" style={{ marginTop: 0 }}>
          The agent will send a signed, machine-readable offer to the merchant. Nothing is purchased
          on your behalf.
        </p>
